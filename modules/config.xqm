...
(:
 ...
 :)
declare variable $config:default-template :="shouchaoben-temp";
...
(:~
 ...
 :)
declare variable $config:data-root :=$config:app-root || "/ShouchaobenDraft";
...
(:~
 ...
 :)
declare variable $config:default-odd :="shouchaoben.odd";
...
(:~
 ...
 :)
declare variable $config:odd-available :=("shouchaoben.odd");
